...
static const char * TAG = "evse-app";
...
{
    ESP_LOGD(TAG, "EVSE App: ApplicationInit()");
    EvseApplicationInit();
}

void ApplicationShutdown()
{
    ESP_LOGD(TAG, "EVSE App: ApplicationShutdown()");
...
extern "C" void app_main()
{
    ...
    ESP_LOGI(TAG, "==================================================");
    ESP_LOGI(TAG, "chip-esp32-evse-app starting. featureMap 0x%08lx", DeviceEnergyManagement::sFeatureMap.Raw());
    ESP_LOGI(TAG, "==================================================");
